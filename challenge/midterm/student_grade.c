...
#define SUBJECTS 3
#define CHARNUM 20
 //반환값이 없는 함수를 제작하여 입력에 배열을 넣어 평균 점수를 출력하려 했다.
void printStudentResults(double Array1[][SUBJECTS], char Array2[][CHARNUM]) {  // 2차원 배열을 함수로 사용하려면 배열의 가로크기를 기입했어야 했다!!!
 ...
 //반환값이 없는 함수를 제작하여 입력에 배열을 넣어 과목별 평균 점수를 출력하려 했다.
